...
var RedstoneApi = /** @class */ (function () {
    function RedstoneApi(redstoneConfig) {
        ...
        this.verifySignature = lodash_1.default.defaultTo(redstoneConfig.verifySignature, LIMESTON_API_DEFAULTS.verifySignature);
        this.defaultProvider = lodash_1.default.defaultTo(redstoneConfig.defaultProvider, LIMESTON_API_DEFAULTS.defaultProvider);
        this.useCache = lodash_1.default.defaultTo(redstoneConfig.useCache, LIMESTON_API_DEFAULTS.useCache);
    }
